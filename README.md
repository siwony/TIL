...
## 분류
### GIT
- [.Ds_store 모두 .gitignore](/git/how-to-ignore-all-ds_store.md)
...
### &nbsp; JPA
- [Entity,EntityManager,EntityManagerFactory]("/BE/Spring/JPA/Entity,EntityManager,EntityManagerFactory")
- [JPA Auditing으로 생성일/수정일 자동화](/BE/Spring/JPA/Auditing)
